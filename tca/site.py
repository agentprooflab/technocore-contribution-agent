...
@media(max-width:900px){.top-meta span:nth-child(-n+2){display:none}.hero{min-height:620px}.hero-stamp{display:none}.metrics{grid-template-columns:1fr 1fr}.metric:nth-child(2){border-right:0}.section-head{grid-template-columns:90px 1fr}.section-head p{grid-column:2}.thesis,.brief-grid{grid-template-columns:1fr}.thesis-main{border-right:0;border-bottom:1px solid var(--line)}.controls{min-height:auto}.demo-guide{grid-template-columns:1fr}.demo-guide article{border-right:0;border-bottom:1px solid var(--line)}.coverage{grid-template-columns:1fr 150px}.coverage-data{grid-column:1/-1}.pipeline{grid-template-columns:1fr 1fr}.stage{border-bottom:1px solid var(--line)}.install{grid-template-columns:1fr}.proof{grid-template-columns:1fr}.proof article{border-right:0;border-bottom:1px solid var(--line)}}
@media(max-width:560px){.shell{width:min(100% - 24px,1320px)}.topbar{height:60px}.hero{min-height:560px}.hero-copy{padding:54px 0}.hero h1{font-size:58px}.metrics{grid-template-columns:1fr}.metric{border-right:0;border-bottom:1px solid var(--line)}.section{padding:68px 0}.section-head{display:block}.section-id{display:block;margin-bottom:18px}.section-head p{margin-top:20px}.thesis-main{padding:24px}.fixture-note,.demo-legend{grid-template-columns:1fr}.controls output{grid-template-columns:1fr}.coverage{grid-template-columns:1fr}.pipeline{grid-template-columns:1fr}.stage{border-right:0}.top-meta{gap:0}.button{width:100%;justify-content:center}}
...
<section class="section" id="brief"><div class="section-head reveal"><span class="section-id">02 / LIVE DEMO</span><h2>Turn the<br>firehose down.</h2><p>This simulates one agent request. Set the maximum response size, then watch the compiler choose which complete signals fit now and which P100 signals continue to the next page.</p></div>
